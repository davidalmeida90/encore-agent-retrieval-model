# Encore — implementation checklist
...
- [x] Set `USER_AGENT` in `corpus/download.py` and download sample 10-K corpus:
  ```bash
  uv run corpus/download.py
  ```
- [x] Confirm `corpus/downloads/manifest.json` lists AAPL, MSFT, NVDA, AMZN, GOOGL filings (2021–2025)
...
## Phase 9 — Running locally

(The project runs on one machine. See RUNNING.md.)
