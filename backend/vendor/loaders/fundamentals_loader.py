...
from vendor.loaders import sec_edgar_client
from vendor.loaders.base import cached_loader_fetch, validate_date_range
from vendor.loaders.sec_frames import ANNUAL_SPAN_DAYS, QUARTER_SPAN_DAYS
...
def _load_schema() -> Any:
    try:
        return importlib.import_module("vendor.loaders._fundamental_schema")
    except ModuleNotFoundError as exc:
        raise RuntimeError(
            "vendor.loaders._fundamental_schema is required for fundamentals loading"
        ) from exc
