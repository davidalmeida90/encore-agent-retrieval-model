...
from vendor.loaders.base import NoAvailableSourceError
...
def _ensure_registered() -> None:
    ...
    _loader_modules = [
        "vendor.loaders.tushare",
        "vendor.loaders.okx",
        "vendor.loaders.binance_loader",
        "vendor.loaders.yfinance_loader",
        "vendor.loaders.akshare_loader",
        "vendor.loaders.baostock_loader",
        "vendor.loaders.tencent_loader",
        "vendor.loaders.mootdx_loader",
        "vendor.loaders.ccxt_loader",
        "vendor.loaders.futu",
        "vendor.loaders.eastmoney_loader",
        "vendor.loaders.sina_loader",
        "vendor.loaders.stooq_loader",
        "vendor.loaders.yahoo_loader",
        "vendor.loaders.finnhub_loader",
        "vendor.loaders.alphavantage_loader",
        "vendor.loaders.tiingo_loader",
        "vendor.loaders.fmp_loader",
        "vendor.loaders.qveris_loader",  # QVERIS-INTEGRATION
        "vendor.loaders.india_broker_loader",
        "vendor.loaders.pykrx_loader",
        "vendor.loaders.longbridge",
        "vendor.loaders.mt5_loader",
        "vendor.loaders.tickerall_loader",
        "vendor.loaders.local_loader",
    ]
    import importlib
